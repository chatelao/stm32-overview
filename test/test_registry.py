...
def test_registry_list_boards():
    with tempfile.TemporaryDirectory() as tmp_dir:
        spec_1 = {
            ...
            "peripherals": {"uarts": 4, "usarts": 2, "i2c": 3, "spi": 4, "can": 2, "adc_channels": 16, "dac_channels": 2, "timers": 10},
        ...
        spec_2 = {
            ...
            "peripherals": {"uarts": 1, "usarts": 1, "i2c": 1, "spi": 1, "can": 0, "adc_channels": 5, "dac_channels": 0, "timers": 4},
